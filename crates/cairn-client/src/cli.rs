...
pub struct Cli {
    ...
    #[clap(long, short = 'v', action = ArgAction::Count, global = true, help_heading = "Global options")]
    pub verbose: u8,
    ...
    #[clap(long, value_enum, global = true, default_value_t = ColorChoice::Auto, help_heading = "Global options")]
